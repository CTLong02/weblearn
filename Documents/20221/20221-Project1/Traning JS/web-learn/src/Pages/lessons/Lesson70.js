...
import img1 from '~/image/lesson70/img1.png';
        ...
        <>
            ...
            <div className={styles.container}>
                ...
                <div className={styles.practice} style={{ height: `${height}px` }}>
                    <ChoiceAnswer
                        contentAnswers={[
                            'Hiển thị màn hình kết quả: "A"',
                            'Hiển thị màn hình kết quả: "B"',
                            'Lỗi biên dịch',
                            'Lỗi thực thi',
                        ]}
                        ans={3}
                        link="http://localhost:3005/learning"
                    ></ChoiceAnswer>
                </div>
            </div>
        </>
