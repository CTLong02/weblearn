            ...
            <div className={styles.container}>
                ...
                <div className={styles.practice} style={{ height: `${height}px` }}>
                    <MultipleCode
                        height={height}
                        testcases={[
                            'Lớp Student có thuộc tính name.',
                            'Lớp Student có thuộc tính age.',
                            'Thuộc tính name có phạm vi truy cập private',
                            'Thuộc tính age có phạm vi truy cập private',
                            'Lớp Student có phương thức getInformation',
                            'Lớp Student có phương thức display',
                            'Phương thức display phải có phạm vi truy cập public',
                            'Phương thức getInformation phải có phạm vi truy cập public',
                        ]}
                    ></MultipleCode>
                </div>
            </div>
