                ...
                <div className={styles.practice} style={{ height: `${height}px` }}>
                    <MultipleCode
                        ...
                        testcases={[
                            ...
                            'Phương thức khởi tạo không tham số Student() và phương thức display() được cài đặt giống như yêu cầu đề bài.',
                            'Phương thức khởi tạo có tham số Student(name: String) và phương thức display() được cài đặt giống như yêu cầu đề bài.',
                            'Phương thức khởi tạo có tham số Student(char: gender) và phương thức display() được cài đặt giống như yêu cầu đề bài.',
                            'Phương thức khởi tạo có tham số Student(name: String, char: gender) và phương thức display() được cài đặt giống như yêu cầu đề bài.',
                        ]}
                    ></MultipleCode>
                </div>
            </div>
