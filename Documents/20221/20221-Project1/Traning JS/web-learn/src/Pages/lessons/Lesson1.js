        ...
        <>
            ...
            <div className={styles.container}>
                ...
                <div className={styles.practice} style={{ height: `${height}px` }}>
                    <ChoiceAnswer
                        contentAnswers={[
                            'Một mô hình lập trình tiên tiến phù hợp với sự phát triển của hầu hết các chương trình.',
                            'Một mô hình lập trình phù hợp với các chương trình vừa và nhỏ.',
                        ]}
                        ans={1}
                        link="http://localhost:3005/learning/Classes%20and%20Objects/2"
                    ></ChoiceAnswer>
                </div>
            </div>
        </>
