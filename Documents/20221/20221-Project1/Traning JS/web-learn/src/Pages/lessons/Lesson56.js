...
import img1 from '~/image/lesson56/img1.png';
import img2 from '~/image/lesson56/img2.png';
            ...
            <div className={styles.container}>
                ...
                <div className={styles.practice} style={{ height: `${height}px` }}>
                    <ChoiceAnswer
                        contentAnswers={[
                            'perimeter = 6.0 \n area = 2.0',
                            'Chương trình chạy nhưng không hiển thị gì',
                            'Lỗi biên dịch',
                            'Lỗi thực thi',
                        ]}
                        ans={3}
                        link="http://localhost:3005/learning/Quiz/57"
                    ></ChoiceAnswer>
                </div>
            </div>
        </>
