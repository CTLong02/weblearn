...
import img1 from '~/image/lesson55/img1.png';
        ...
        <>
            ...
            <div className={styles.container}>
                ...
                <div className={styles.practice} style={{ height: `${height}px` }}>
                    <ChoiceAnswer
                        contentAnswers={['10', '20', 'Lỗi biên dịch', 'Lỗi thực thi']}
                        ans={2}
                        link="http://localhost:3005/learning/Quiz/56"
                    ></ChoiceAnswer>
                </div>
            </div>
        </>
