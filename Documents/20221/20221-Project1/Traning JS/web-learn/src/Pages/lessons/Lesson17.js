            ...
            <div className={styles.container}>
                ...
                <div className={styles.practice} style={{ height: `${height}px` }}>
                    <MultipleCode
                        height={height}
                        testcases={[
                            'Lớp ArrayCalculator có 2 phương thức static sumOfArray được nạp chồng với phạm vi truy cập public',
                            'Phương thức sumOfArray trả về đúng kết quả theo yêu cầu đề bài.',
                        ]}
                    ></MultipleCode>
                </div>
            </div>
