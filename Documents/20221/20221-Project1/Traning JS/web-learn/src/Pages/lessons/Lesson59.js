...
import img1 from '~/image/lesson59/img1.png';
import img2 from '~/image/lesson59/img2.png';
            ...
            <div className={styles.container}>
                ...
                <div className={styles.practice} style={{ height: `${height}px` }}>
                    <ChoiceAnswer
                        ...
                        ans={3}
                        link="http://localhost:3005/learning/Quiz/60"
                    ></ChoiceAnswer>
                </div>
            </div>
        </>
